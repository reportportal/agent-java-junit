...
package com.epam.reportportal.junit.features.step;
...
public class ManualStepReporterFailureTest {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ManualStepReporterFailureTest.class);
