...
import com.epam.reportportal.junit.features.nested.NestedStepFeaturePassedTest;
...
public class NestedStepPassedTest {
	...
	public void test_simple_nested_step_case() {
		...
		assertEquals("I am nested step with parameter - '" + NestedStepFeaturePassedTest.PARAM + "'", startTestItemRQ.getName());
