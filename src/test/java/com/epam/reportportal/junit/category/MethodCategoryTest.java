...
import com.epam.reportportal.junit.features.category.SimpleMethodCategoryTest;
...
public class MethodCategoryTest {
	...
	@Test
	public void verify_method_categories_go_to_value_only_attributes() {
		TestUtils.runClasses(SimpleMethodCategoryTest.class);
		...
		assertThat(item.getAttributes(), allOf(notNullValue(), hasSize(1)));
		ItemAttributesRQ attribute = item.getAttributes().iterator().next();
