...
## [5.4.6]
### Changed
- Client version updated to [5.4.12](https://github.com/reportportal/client-java/releases/tag/5.4.12), by @HardNorth
...
## [5.4.3]
### Changed
- Client version updated to [5.4.7](https://github.com/reportportal/client-java/releases/tag/5.4.7), by @HardNorth
